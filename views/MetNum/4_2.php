		...
		<div id="content">
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="margintop25">
				<div class="container-fluid" id="padding0">
					<h1>
                        Intégration par trapèzes (ordre un)
					</h1>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="padding0">
				<div class="container-fluid">
					<div class="moving">
						...
						>>
						<span class="badge badge-secondary">Trapèzes</span>
					</div>
			...
			<article>
		 		<div id="div_resumo">
		 			<h3>Résumé</h3>
		 			<div class="subsec">
                        <p> Cette méthode consiste à diviser un intervalle d'intérêt \([a, \ b] \) en \(n \) intervalles également espacés, puis nous ajoutons l'aire de chaque trapèze pour chaque intervalle. </p>

                        <img src="https://upload.wikimedia.org/wikipedia/commons/a/a8/Calkowanie_numeryczne-metoda_trapezow.png">
		 			</div>
		 		</div>
		 		...
		 		<div id="div_teoria">
		 			<h3>Théorie</h3>
		 			<div class="subsec">
                        <p> Comme pour l'idée d'approcher dans l'ordre zéro, il nous est également possible d'avoir des intervalles inégaux. Et comme dans le cas de l'ordre zéro, nous aurons que les n intervalles auront la même longueur. Contrairement à l'ordre zéro, nous choisirons les extrémités d'un intervalle donné formant des trapèzes. </p>
                    </div>
		 		</div>
