		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="padding0">
				<div class="container-fluid">
					<div class="moving">
						...
						>>
						<span class="badge badge-secondary">Hermite</span>
					</div>
			...
			<article>
		 		<div id="div_resumo">
		 			<h3>Résumé</h3>
		 			<div class="subsec">
		 				<p>Cette méthode consiste à prendre \(n+1\) points de la forme \(\left(x_i, \ y_i, \ d_i\right)\), et à interpoler par un polynôme \(f(x)\) tel que :</p>
		 		...
		 		<div id="div_teoria">
		 			<h3>Théorie</h3>
		 			<div class="subsec">
		 				<p>Cette méthode reprend l'idée de <a href="controleur.php?action=MetNum/2_1">Interpolation de Lagrange</a> et ajouter des dérivés.</p>
		 			</div>
		 		</div>
                ...
                <div id="div_restricoes">
		 		...
		 		<div id="div_parametros">
		 			...
		 			<div class="subsec">
		 				<ul>
		 					<li>Les valeurs des \(n+1\) points : \(\left(x_i, \ y_i, \ d_i\right)\)</li>
		 				</ul>
		 			</div>
		 		</div>
