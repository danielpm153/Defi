		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="padding0">
				<div class="container-fluid">
					<div class="moving">
						...
						>>
						<a href="controleur.php?action=MetNum/1" class="badge badge-primary">Interpolation</a>
						>>
						<span class="badge badge-secondary">Spline</span>
					</div>
			...
			<article>
		 		<div id="div_resumo">
		 			<h3>Resumo</h3>
		 			<div class="subsec">
		 				<p>Cette méthode consiste à interpoler \(n+1\) points par une fonction \(f\).
                            Où \(f\) est un polynôme de degré \(m\) dans chacun de \(n\) intervalles</p>
		 				<ul>
		 					<li>Spline linéaire : \(m = 1\)</li>
		 					<li>Spline quadratique : \(m = 2\)</li>
		 					<li>Spline cubique : \(m = 3\)</li>
		 				</ul>
		 			</div>
		 		</div>
                ...
                <div id="div_restricoes">
		 		...
		 		<div id="div_parametros">
		 			...
		 			<div class="subsec">
		 				<ul>
		 					<li>Le nombre d'intervalles : \(n\)</li>
		 					<li>Les \(n+1\) points : \(\left(x_i, \ y_i\right)\)</li>
		 					<li>Le type de <em>spline</em>, ou la valeur de \(m\)</li>
		 				</ul>
		 			</div>
		 		</div>
