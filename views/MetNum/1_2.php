		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="padding0">
				<div class="container-fluid">
					<div class="moving">
						...
						>>
						<span class="badge badge-secondary">Point Fixe</span>
					</div>
			...
			<article>
		 		<div id="div_resumo">
		 			<h3>Résumé</h3>
		 			<div class="subsec">
                        <p> Cette méthode trouve une racine de \(f(x)\) en approximant successivement les valeurs à l'aide d'une fonction \(g(x)\) </p>
                        <p> Autrement dit, nous estimons une valeur initiale \(x_0\), puis nous calculons les éléments suivants à partir de cette valeur: </p>

                        $$ x_ {k + 1} = x_k + g (x_k) $$

                        <p> À partir de plusieurs itérations, nous pouvons obtenir une bonne estimation de la racine: \(x_{k}\) </p>
                    </div>
		 		</div>
		 		...
		 		<div id="div_teoria">
		 			<h3>Théorie</h3>
		 			<div class="subsec">
		 				<p>Le travail consiste donc à trouver la relation entre la fonction \(f(x)\) et \(g(x)\)</p>
		 			</div>
		 		</div>
		 		...
		 		<div id="div_restricoes">
		 			...
		 			<div class="subsec">
		 				<ul>
		 					<li>\(g'(x) < 1\) pour garantir la convergence</li>
		 				</ul>
		 			</div>
		 		</div>
		 		...
		 		<div id="div_parametros">
		 			...
		 			<div class="subsec">
		 				<ul>
		 					<li>L'estimation \(x_0\)</li>
		 					<li>La fonction \(g(x)\)</li>
