		...
		<div id="content">
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="margintop25">
				<div class="container-fluid" id="padding0">
					<h1>
                        Intégration par rectangles (ordre zéro)
					</h1>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="padding0">
				<div class="container-fluid">
					<div class="moving">
						...
						>>
						<span class="badge badge-secondary">Rectangulaire</span>
					</div>
			...
			<article>
		 		<div id="div_resumo">
		 			<h3>Résumé</h3>
		 			<div class="subsec">
		 				<p>Cette méthode consiste à diviser un intervalle d'intérêt \([a, \ b]\) en \(n\) intervalles également espacés, puis à ajouter l'aire de chaque rectangle pour chaque intervalle.</p>
		 				
		 				<img src="https://upload.wikimedia.org/wikipedia/commons/e/ea/Integration_rectangle.png">
		 			</div>
		 		</div>
		 		...
		 		<div id="div_teoria">
		 			<h3>Théorie</h3>
		 			<div class="subsec">
		 				<p>Cet algorithme d'intégration numérique consiste à diviser l'intervalle \([a, \ b]\) en n intervalles formant ainsi \(n+1\) points.</p>
		 			</div>
		 		</div>
		 		...
		 		<div id="div_restricoes">
		 			...
		 			<div class="subsec">
		 				<ul>
		 					<li>\(n > 1\), pour que nous ayons au moins deux intervalles.</li>
		 				</ul>
		 			</div>
		 		</div>
		 		...
		 		<div id="div_parametros">
		 			...
		 			<div class="subsec">
		 				<ul>
		 					...
		 					<li>La fonction \(f(x)\), défini dans l'intervalle \([a, \ b]\)</li>
		 					<li>La valeur \(n\), nombre d'intervalles</li>
		 				</ul>
		 			</div>
		 		</div>
