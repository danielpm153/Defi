		...
		<div id="content">
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="margintop25">
				<div class="container-fluid" id="padding0">
					<h1>
                        Intégration de (3/8) Simpson (ordre trois)
					</h1>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="padding0">
				<div class="container-fluid">
					<div class="moving">
						...
						>>
						<span class="badge badge-secondary">3/8 de Simpson</span>
					</div>
			...
			<article>
		 		<div id="div_resumo">
		 			<h3>Résumé</h3>
		 			<div class="subsec">
                        <p> Cette méthode consiste à diviser une plage d'intérêt \([a, \ b] \) en \(n \) intervalles également espacés. Ensuite, nous ajoutons les intégrales de chaque intervalle, où l'intégrale dans un intervalle est approximée par l'intégrale d'un polynôme d'ordre \(3 \) (cubique). </p>
                    </div>
		 		</div>
		 		...
		 		<div id="div_teoria">
		 			<h3>Théorie</h3>
		 			<div class="subsec">
                        <p> De la même manière que nous avons l’ordre deux, qui utilise l’interpolation, l’ordre trois utilise également l’interpolation. Pour cela, il faudrait que n soit divisible par 3, et on résout cela en divisant l'intervalle [a, b] en 3n intervalles d'égale longueur. Et chaque intervalle est ensuite intégré séparément à l'aide d'une fonction d'interpolation du troisième ordre. </p>
		 			</div>
		 		</div>
