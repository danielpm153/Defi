		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light" id="padding0">
				<div class="container-fluid">
					<div class="moving">
						<a href="index.html" class="badge badge-primary">Index</a>
						>>
						<a href="2.php" class="badge badge-primary">Interpolation</a>
						>>
						<span class="badge badge-secondary">Lagrange</span>
					</div>
			...
			<article>
		 		<div id="div_resumo">
		 			<h3>Résumé</h3>
		 			<div class="subsec">
		 				<p>Cette méthode consiste à prendre \(n+1\) points de la forme \(\left(x_i, \ y_i\right)\) et à interpoler par un polynôme \(f(x)\) tel que :</p>
                ...
                <div id="div_restricoes">
		 		...
		 		<div id="div_parametros">
		 			...
		 			<div class="subsec">
		 				<ul>
		 					<li>les valeurs des \(n+1\) points : \(\left(x_i, \ y_i\right)\)</li>
		 				</ul>
		 			</div>
		 		</div>
