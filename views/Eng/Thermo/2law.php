...
<div class="wrapper">
    ...
    <div id="content">
        <article>
            <h1>Entropie</h1>
            <img style="width: 30%" src="https://static.todamateria.com.br/upload/en/tr/entropiabolinhas.jpg">

            <p>
                Il s'agit d'une quantité physique connue sous le nom d'entropie, qui est une mesure du nombre d'états thermodynamiques d'un système, en d'autres termes, l'entropie fournit une mesure du caractère aléatoire ou de la désorganisation d'un système.
            </p>
            ...
            <div class="subsec">
                <ul>
                    <li>\(\Delta S\) - variation d'entropie.</li>
                </ul>
            </div>
        </article>
    </div>
