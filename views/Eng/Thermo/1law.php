...
<div class="wrapper">
    ...
    <div id="content">
        <article>
            <h1>Conservation de l'énergie</h1>
            <img style="width: 30%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsGzrh4OGydwwxJRlXh8NU_G4HehgEcGU76A&usqp=CAU">

            <p>
                La variation de l'énergie interne d'un système thermodynamique est mesurée par la différence entre la quantité de chaleur absorbée par celui-ci et la quantité de travail effectuée par lui ou sur lui.
            </p>
            ...
            <div class="subsec">
                <ul>
                    <li>\(\Delta U\) - variation d'énergie interne,</li>
                    <li>\(Q\) - chaleur, </li>
                    <li>\(T\) - travail.</li>
                </ul>
            </div>
