	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<article>
                <h2>Introduction</h2>
                <p>
                    En Python, les Sets sont une collection d'éléments non ordonnée, partiellement immuable, qui ne peut pas contenir d'éléments en double. Comme les Sets sont partiellement immuables, ils sont autorisés à ajouter et à supprimer des éléments.
                </p>
                <h4>Déclarer des Set</h4>
                <div class="subsec">
                    <p>Pour créer une Set en Python, la syntaxe est la suivante :</p>
                    <pre class="language-python">
                        <code class="language-python">
                            >>>L1 = set()<span style="color: palevioletred">#Création d'une set vide</span>
                            >>>L2 = {1,2,3,4,3,5,2}<span style="color: palevioletred">#Création d'une set d'entiers</span>
                            >>>L2<span style="color: palevioletred">#Les valeurs répétées sont ignorées</span>
                            {1, 2, 3, 4, 5}
                            >>>L3 = {1,"Daniel",[1,"Banana"],2}<span style="color: palevioletred">#Il n'est pas possible d'insérer des objets modifiables</span>
                            TypeError: unhashable type: 'list'
                        </code>
                    </pre>
                </div>

                <h4>Récupérer un élément de Set</h4>
                <div class="subsec">
                    <p>Pour obtenir un élément du set, nous utilisons la syntaxe suivante :</p>
                    <pre class="language-python">
                        <code class="language-python">
                            >>>L2[0]<span style="color: palevioletred">#premier élément du Set</span>
                            >>>1
                            >>>L2[2]<span style="color: palevioletred">#troisième élément du Set</span>
                            >>>3
                            >>>L2[-1]<span style="color: palevioletred">#Dernier élément du Set</span>
                            >>>4
                        </code>
                    </pre>
                </div>
